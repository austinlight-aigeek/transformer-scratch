...
class DecoderBlock(nn.Module):
    ...
    def forward(self, x, encoder_output, src_mask, tgt_mask):
        ...
        # The Cross-Attention block using two 'encoder_output's for key and value plus the source language mask. It
        # also takes in 'x' for Decoder queries
...
# Building Decoder A Decoder can have several Decoder Blocks
